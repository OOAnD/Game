...
namespace SpaceBattle.Tests
{
    public class StartCommandTest
    {
        ...
        public void Execute_ShouldCorrectStartAction()
        {
            ...
            Ioc.Resolve<ICommand>("IoC.Register", "Macro.TestCommand", (object[] args) => macro.Object).Execute();
            Ioc.Resolve<ICommand>("IoC.Register", "Commands.CommadInjectable", (object[] args) => injectable.Object).Execute();
            Ioc.Resolve<ICommand>("IoC.Register", "Game.Object.Actions.Set", (object[] args) => setCommand.Object).Execute();
            Ioc.Resolve<ICommand>("IoC.Register", "Game.Queue", (object[] args) => queue.Object).Execute();
            Ioc.Resolve<ICommand>("IoC.Register", "Commands.Send", (object[] args) => sendCommand.Object).Execute();
